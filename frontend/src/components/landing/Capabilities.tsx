...
const features = [
  {
    ...
    description:
      "Endocrinology, Cardiology, and Nephrology models concurrently analyze the patient before reaching a unified consensus plan.",
  },
  {
    icon: Database,
    title: "Evidence Grounding",
    description:
      "Every AI claim is mathematically mapped to a specific sentence in the raw patient record to eliminate hallucination.",
  },
  {
    icon: ShieldAlert,
    title: "Missing Data Hard-Stop",
    description:
      "If a crucial lab value is missing, the Archivist engine halts the recommendation pipeline and flags the physician immediately.",
  },
  {
    icon: History,
    title: "Immutable Audit Trail",
    description:
      "Every agent interaction, internal conflict, and final resolution is cryptographically sealed in the patient's review history.",
  },
  {
    icon: FileCheck2,
    title: "ICD-10 Intelligence",
    description:
      "Automatically maps chief complaints and raw notes to exact ICD-10 billing codes alongside clinical confidence scores.",
  },
  {
    icon: Key,
    title: "Human-in-the-Loop",
    description:
      "No plan is activated without a physical, audited sign-off from the attending physician.",
  },
];
