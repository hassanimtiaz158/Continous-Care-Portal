...
export function Sidebar() {
  ...
  return (
    <aside className="h-full w-16 flex flex-col items-center py-6 bg-slate border-r border-line shrink-0 transition-all z-50">
          ...
          return (
            <div
              ...
              className={cn(
                ...
                isActive
                  ? "bg-void-2 text-gold shadow-sm cursor-pointer"
      ...
      <div className="mt-auto px-2 w-full">
        <button
          className="w-12 h-12 rounded-xl flex items-center justify-center mx-auto text-muted/40 cursor-not-allowed transition-colors"
