    ...
    <AnimatePresence>
      {open && (
        <div className="fixed inset-0 z-[100] bg-void/80 backdrop-blur-sm flex items-start justify-center pt-[15vh]">
          ...
          >
            <Command label="Global Command Menu" className="flex flex-col bg-transparent w-full">
              ...
              <Command.List className="max-h-[300px] overflow-y-auto p-2 outline-none">
                ...
                <Command.Group
                  heading={
                    <span className="text-[10px] font-mono uppercase tracking-widest text-muted/60 px-2 py-1 block">
                      Actions
                    </span>
                  }
                >
                ...
                <Command.Group
                  heading={
                    <span className="text-[10px] font-mono uppercase tracking-widest text-muted/60 px-2 pt-4 pb-1 block">
                      Patients
                    </span>
                  }
                >
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <span className="leading-tight">
                          {p.name} <span className="text-muted text-xs">({p.id})</span>
                        </span>
