...
export function PhysicianDecision({
  onApprove,
  onReject,
  isLocked,
  onExport,
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted font-mono uppercase tracking-widest mt-1">
                  Immutable Audit Ledger Generated
                </p>
              </div>
            </div>
            <Button
              onClick={onExport}
              variant="outline"
              className="border-gold/30 text-gold hover:bg-gold/10 font-mono text-[10px] uppercase tracking-widest gap-2 h-10"
            >
          ...
          <>
            <div className="flex-1">
              ...
              <p className="text-xs text-muted max-w-md leading-relaxed">
                By signing off, you verify that you have reviewed the AI consensus and agree with
                the proposed clinical plan. This action is irreversible.
              </p>
            </div>
